...
t1 = Transaction.create(post_date: '1/23/23', purchase: false, sale: true, buyer_id: u1.id, seller_id: u2.id, item_id: i1.id)
t2 = Transaction.create(post_date: '1/22/23', purchase: false, sale: true, buyer_id: u1.id, seller_id: u2.id, item_id: i2.id)
t3 = Transaction.create(post_date: '1/21/23', purchase: true, sale: false, buyer_id: u2.id, seller_id: u1.id, item_id: i3.id)